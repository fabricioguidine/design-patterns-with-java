...
class StudentTest {
    ...
    void shouldNotifyOneStudent() {
        ...
        // Assert
        assertEquals(
                "John, application updated for: Scholarship{course='Undergraduate', value=1000.0, quantity=1}",
    ...
    void shouldNotifyMultipleStudents() {
        ...
        // Assert
        assertEquals(
                "Peter, application updated for: Scholarship{course='Graduate', value=1500.0, quantity=2}",
                student1.getLastNotification());
        assertEquals(
                "Mary, application updated for: Scholarship{course='Graduate', value=1500.0, quantity=2}",
