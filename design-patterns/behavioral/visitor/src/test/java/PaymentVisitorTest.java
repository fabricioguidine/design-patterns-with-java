...
class PaymentVisitorTest {
    ...
    void shouldDisplayPixPayment() {
        ...
        // Assert
        assertEquals("PixPayment{" + "pixKey=asdfghjkl" + ", value=900.0" + '}', result);
    }
    ...
    void shouldDisplayCreditCardPayment() {
        ...
        // Assert
        assertEquals(
                "CreditCardPayment{" + "cardNumber=1234567890"
                        + ", expiryDate='10/10'"
                        + ", securityCode='999'"
                        + ", value=500.0"
                        + '}',
    ...
    void shouldDisplayInvoicePayment() {
        ...
        // Assert
        assertEquals("InvoicePayment{" + "barcode=123456" + ", value=500.0" + '}', result);
    }
}
